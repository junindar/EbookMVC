...
namespace MVCPerpustakaan.Controllers
{
    ...
    public class KategoriController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KategoriId,NamaKategori")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KategoriId,NamaKategori")] Kategori kategori)
        {
            if (ModelState.IsValid)
            {
